...
| No  | Description | Result |
| --- | ----------- | ------ |
| D.1 |Create a Python script to determine the LM hash and NTLM hash of the following words | "Napier"<br>"Foxtrot" |
...
| No  | Description | Result |
| --- | ----------- | ------ |
| E.1 | Create a Python script to create the APR1 hash for the following:<br> [just list first four characters of the hash]| “changeme”:<br>“123456”:<br>“password”|
...
| No  | Description | Result |
| --- | ----------- | ------ |
| F.1 | Create a Python script to create the SHA for the following:<br> [just list first four characters of the hash]| “changeme”:<br>“123456”:<br>“password”|
